...
/// See article "A Fast Triangle-Triangle Intersection Test", Journal of Grap$$anonymous$$cs Tools, 2(2), 1997.
/// </summary>

namespace TriTriOverlap
{
    public  class TriTriOverlap
    {
        private  void Sort(Vector2 v)
        {
            if (v.x > v.y)
            {
                float c;
        ...
        /// <summary>
        /// T$$anonymous$$s edge to edge test is based on Franlin Antonio's gem: "Faster Line Segment Intersection", in Grap$$anonymous$$cs Gems III, pp. 199-202 
        /// </summary>
        private  bool EdgeEdgeTest(Vector3 v0, Vector3 v1, Vector3 u0, Vector3 u1, int i0, int i1)
        {
        ...
        private  bool EdgeAgainstTriEdges(Vector3 v0, Vector3 v1, Vector3 u0, Vector3 u1, Vector3 u2, short i0, short i1)
        {
        ...
        private  bool PointInTri(Vector3 v0, Vector3 u0, Vector3 u1, Vector3 u2, short i0, short i1)
        {
        ...
        private  bool TriTriCoplanar(Vector3 N, Vector3 v0, Vector3 v1, Vector3 v2, Vector3 u0, Vector3 u1, Vector3 u2)
        {
            float[] A = new float[3];
            short i0, i1;
        ...
        private  bool ComputeIntervals(float VV0, float VV1, float VV2,
        ...
        public  bool TriTriIntersect(Vector3 v0, Vector3 v1, Vector3 v2, Vector3 u0, Vector3 u1, Vector3 u2)
        {
            ...
            // t$$anonymous$$s is the simplified projection onto L
            vp0 = v0[index];
            vp1 = v1[index];
            vp2 = v2[index];
